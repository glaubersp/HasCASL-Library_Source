...
setup "Header.initialize
       [\"NotFalse\", \"NotTrue\", \"AndFalse\", \"AndTrue\", \"AndSym\",
        ...
        \"TO5\", \"TO6\", \"IUO01\", \"IUO02\", \"IUO03\", \"IUO04\",
        \"IUO05\", \"IUO06\", \"IUO07\", \"IOO13\", \"IOO14\", \"IOO15\",
        \"IOO16\", \"IOO17\", \"IOO18\", \"IOO19\", \"IOO20\", \"IOO21\",
        \"IOO22\", \"IOO23\", \"IOO24\", \"IOO25\", \"IOO26\", \"IOO27\",
        \"IOO28\", \"IOO29\", \"IOO30\", \"IOO31\", \"IOO32\", \"IOO33\",
        \"IBO5\", \"IBO6\", \"IBO7\", \"IBO8\", \"IBO9\", \"IBO10\",
        \"IBO11\", \"IBO12\", \"EitherLeftDef\", \"EitherRightDef\",
        \"IEE01\", \"IEE02\", \"IEE03\", \"IEO01\", \"IEO02\", \"IEO03\",
        \"IEO04\", \"IEO05\", \"IEO06\", \"IEO07\", \"IEO08\", \"IEO09\",
        \"IEO10\", \"IEO11\", \"IEO12\", \"IEO13\"]"
...
datatype ('a, 'b) Either = X_Left "'a partial" ("Left''/'(_')" [3] 999) |
                           X_Right "'b partial" ("Right''/'(_')" [3] 999)
...
"ALL (f :: 'a partial => 'c partial).
 ALL (g :: 'b partial => 'c partial).
 ALL (x :: 'a partial). either f g (makePartial (Left'(x))) = f x"

EitherRightDef [rule_format] :
"ALL (f :: 'a partial => 'c partial).
 ALL (g :: 'b partial => 'c partial).
 ALL (y :: 'b partial). either f g (makePartial (Right'(y))) = g y"

IEE01 [rule_format] :
"ALL (x :: 'e partial).
 ALL (y :: 'e partial).
 makePartial (Left'(x)) ==' makePartial (Left'(y)) = x ==' y"

IEE02 [rule_format] :
"ALL (w :: 'ee partial).
 ALL (z :: 'ee partial).
 makePartial (Right'(z)) ==' makePartial (Right'(w)) = z ==' w"

IEE03 [rule_format] :
"ALL (x :: 'e partial).
 ALL (z :: 'ee partial).
 ~ makePartial (Left'(x)) ==' makePartial (Right'(z))"
...
apply(simp only: OrDef GeDef)
apply(case_tac "makePartial (Right'(z)) <' makePartial (Left'(x))")
apply(simp)
apply(case_tac "makePartial (Left'(x)) ==' makePartial (Right'(z))")
by auto
...
"ALL (x :: 'o partial).
 ALL (z :: 'oo partial).
 makePartial (Right'(z)) >=' makePartial (Left'(x))"
apply(rule allI)+
apply(simp only: GeqDef)
apply(simp only: OrDef GeDef)
apply(case_tac "makePartial (Left'(x)) <' makePartial (Right'(z))")
...
"ALL (x :: 'o partial).
 ALL (z :: 'oo partial).
 compare (makePartial (Left'(x))) (makePartial (Right'(z))) =='
 makePartial EQ =
 makePartial (Left'(x)) ==' makePartial (Right'(z))"
by auto
...
"ALL (x :: 'o partial).
 ALL (z :: 'oo partial).
 makePartial (Left'(x)) <=' makePartial (Right'(z)) =
 X_max (makePartial (Left'(x))) (makePartial (Right'(z))) =='
 makePartial (Right'(z))"
apply(rule allI)+
...
"ALL (x :: 'o partial).
 ALL (z :: 'oo partial).
 makePartial (Left'(x)) <=' makePartial (Right'(z)) =
 X_min (makePartial (Left'(x))) (makePartial (Right'(z))) =='
 makePartial (Left'(x))"
apply(rule allI)+
apply(simp add: LeqDef)
done

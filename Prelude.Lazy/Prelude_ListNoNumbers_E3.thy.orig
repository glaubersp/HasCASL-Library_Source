theory Prelude_ListNoNumbers_E3
...
TO3 [rule_format] :
"ALL (x :: 'a partial).
 ALL (y :: 'a partial). Not' Not' (x <' y) | Not' (x <' y)"
...
"ALL (w :: 'b partial).
 ...
 ALL (z :: 'b partial).
 ALL (zs :: 'b List partial). z <' w --> X_Cons z zs <' X_Cons w ws"
...
"ALL (w :: 'b partial).
 ...
 ALL (z :: 'b partial).
 ALL (zs :: 'b List partial).
 z ==' w --> X_Cons z zs <' X_Cons w ws = zs <' ws"
...
"ALL (w :: 'b partial).
 ...
 ALL (z :: 'b partial).
 ALL (zs :: 'b List partial).
 ~ z <' w & ~ z ==' w --> ~ X_Cons z zs <' X_Cons w ws"

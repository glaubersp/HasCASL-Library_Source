...
ML "Header.initialize
    [\"Comp1\", \"IdDef\", \"FlipDef\", \"FstDef\", \"SndDef\",
     ...
     \"quot_rem_Int_1\", \"power_Int\", \"ga_generated_Rat\",
     \"equality_Rat\", \"Int2Rat_embedding\", \"ga_comm___XPlus___2_1\",
     \"ga_assoc___XPlus___2_1\", \"ga_right_unit___XPlus___2_1\",
     \"ga_left_unit___XPlus___2_1\", \"ga_left_comm___XPlus___2_1\",
     \"ga_comm___Xx___2_1\", \"ga_assoc___Xx___2_1\",
     \"ga_right_unit___Xx___2_1\", \"ga_left_unit___Xx___2_1\",
     \"ga_left_comm___Xx___2_1\", \"ga_comm_min_2_1\",
     \"ga_comm_max_2_1\", \"ga_assoc_min_2_1\", \"ga_assoc_max_2_1\",
     \"ga_left_comm_min_2_1\", \"ga_left_comm_max_2_1\",
     \"leq_def_Rat\", \"geq_def_Rat\", \"less_def_Rat\",
     \"greater_def_Rat\", \"minus_def_Rat\", \"abs_def_Rat\",
     \"add_def_Rat\", \"sub_def_Rat\", \"mult_def_Rat\",
     \"min_def_Rat\", \"max_def_Rat\", \"divide_def1_Rat\",
     \"divide_def2_Rat\", \"power_0_Rat\", \"power_suc_Rat\",
     \"power_neg_Rat\", \"distr1_Rat\", \"distr2_Rat\",
     \"sub_rule_Rat\", \"divide_dom_Rat\", \"divide_rule_Rat\",
     \"power_Rat\", \"AbsSignumLaw\", \"IPN01\", \"IPN02\", \"IPN03\",
     \"IPN04\", \"IPN05\", \"IPN06\", \"IPN07\", \"INN01\", \"INN02\",
     \"INN03\", \"INN04\", \"INN05\", \"INN06\", \"INN07\", \"IIN01\",
     \"IIN02\", \"IIN03\", \"IIN04\", \"IIN05\", \"IIN06\", \"IIN07\",
     \"IIN07_1\", \"IIN08\", \"IIN09\", \"IRN01\", \"IRN02\", \"IRN03\",
     \"IRN04\", \"IRN05\", \"IRN06\", \"IRN07\", \"IRN07_1\", \"IRN08\",
     \"IRN09\", \"IRI01\", \"IRI02\", \"IRI03\", \"IRI04\", \"IRI05\",
     \"IRI06\", \"IRI01_1\", \"IRI02_1\", \"IRF01\", \"IRF02\",
     \"ICE01\", \"ICE02\", \"ICO04\", \"ICO05\", \"ICO06\", \"ICO07\",
     \"ICO01\", \"ICO02\", \"ICO03\", \"ICO08\", \"ICO09\", \"ICO10\",
     \"ICO11\", \"StringT1\", \"StringT2\", \"StringT3\", \"StringT4\",
     \"StringT5\"]"
...
X_all :: "('a partial => bool) => 'a List partial => bool"
X_andL :: "bool List partial => bool" ("andL/'(_')" [3] 999)
X_any :: "('a partial => bool) => 'a List partial => bool"
...
X_orL :: "bool List partial => bool" ("orL/'(_')" [3] 999)
...
slash_001 [rule_format] : "makePartial '\\001' = chr(gn_inj(1_3))"
...
"makePartial '\\010' = chr(gn_inj(1_3) @@ 0'')"

slash_011 [rule_format] :
"makePartial '\\011' = chr(gn_inj(1_3) @@ gn_inj(1_3))"

slash_012 [rule_format] :
"makePartial '\\012' = chr(gn_inj(1_3) @@ 2'')"

slash_013 [rule_format] :
"makePartial '\\013' = chr(gn_inj(1_3) @@ 3'')"

slash_014 [rule_format] :
"makePartial '\\014' = chr(gn_inj(1_3) @@ 4'')"

slash_015 [rule_format] :
"makePartial '\\015' = chr(gn_inj(1_3) @@ 5'')"

slash_016 [rule_format] :
"makePartial '\\016' = chr(gn_inj(1_3) @@ 6'')"

slash_017 [rule_format] :
"makePartial '\\017' = chr(gn_inj(1_3) @@ 7'')"

slash_018 [rule_format] :
"makePartial '\\018' = chr(gn_inj(1_3) @@ 8'')"

slash_019 [rule_format] :
"makePartial '\\019' = chr(gn_inj(1_3) @@ 9'')"

slash_020 [rule_format] : "makePartial '\\020' = chr(2'' @@ 0'')"

slash_021 [rule_format] :
"makePartial '\\021' = chr(2'' @@ gn_inj(1_3))"
...
"makePartial '\\031' = chr(3'' @@ gn_inj(1_3))"
...
"makePartial '\\041' = chr(4'' @@ gn_inj(1_3))"
...
"makePartial '\\051' = chr(5'' @@ gn_inj(1_3))"
...
"makePartial '\\061' = chr(6'' @@ gn_inj(1_3))"
...
"makePartial '\\071' = chr(7'' @@ gn_inj(1_3))"
...
"makePartial '\\081' = chr(8'' @@ gn_inj(1_3))"
...
"makePartial '\\091' = chr(9'' @@ gn_inj(1_3))"
...
"makePartial '\\100' = chr(gn_inj(1_3) @@ (0'' @@ 0''))"

slash_101 [rule_format] :
"makePartial '\\101' = chr(gn_inj(1_3) @@ (0'' @@ gn_inj(1_3)))"

slash_102 [rule_format] :
"makePartial '\\102' = chr(gn_inj(1_3) @@ (0'' @@ 2''))"

slash_103 [rule_format] :
"makePartial '\\103' = chr(gn_inj(1_3) @@ (0'' @@ 3''))"

slash_104 [rule_format] :
"makePartial '\\104' = chr(gn_inj(1_3) @@ (0'' @@ 4''))"

slash_105 [rule_format] :
"makePartial '\\105' = chr(gn_inj(1_3) @@ (0'' @@ 5''))"

slash_106 [rule_format] :
"makePartial '\\106' = chr(gn_inj(1_3) @@ (0'' @@ 6''))"

slash_107 [rule_format] :
"makePartial '\\107' = chr(gn_inj(1_3) @@ (0'' @@ 7''))"

slash_108 [rule_format] :
"makePartial '\\108' = chr(gn_inj(1_3) @@ (0'' @@ 8''))"

slash_109 [rule_format] :
"makePartial '\\109' = chr(gn_inj(1_3) @@ (0'' @@ 9''))"

slash_110 [rule_format] :
"makePartial '\\110' = chr(gn_inj(1_3) @@ (gn_inj(1_3) @@ 0''))"

slash_111 [rule_format] :
"makePartial '\\111' =
 chr(gn_inj(1_3) @@ (gn_inj(1_3) @@ gn_inj(1_3)))"

slash_112 [rule_format] :
"makePartial '\\112' = chr(gn_inj(1_3) @@ (gn_inj(1_3) @@ 2''))"

slash_113 [rule_format] :
"makePartial '\\113' = chr(gn_inj(1_3) @@ (gn_inj(1_3) @@ 3''))"

slash_114 [rule_format] :
"makePartial '\\114' = chr(gn_inj(1_3) @@ (gn_inj(1_3) @@ 4''))"

slash_115 [rule_format] :
"makePartial '\\115' = chr(gn_inj(1_3) @@ (gn_inj(1_3) @@ 5''))"

slash_116 [rule_format] :
"makePartial '\\116' = chr(gn_inj(1_3) @@ (gn_inj(1_3) @@ 6''))"

slash_117 [rule_format] :
"makePartial '\\117' = chr(gn_inj(1_3) @@ (gn_inj(1_3) @@ 7''))"

slash_118 [rule_format] :
"makePartial '\\118' = chr(gn_inj(1_3) @@ (gn_inj(1_3) @@ 8''))"

slash_119 [rule_format] :
"makePartial '\\119' = chr(gn_inj(1_3) @@ (gn_inj(1_3) @@ 9''))"

slash_120 [rule_format] :
"makePartial '\\120' = chr(gn_inj(1_3) @@ (2'' @@ 0''))"

slash_121 [rule_format] :
"makePartial '\\121' = chr(gn_inj(1_3) @@ (2'' @@ gn_inj(1_3)))"

slash_122 [rule_format] :
"makePartial '\\122' = chr(gn_inj(1_3) @@ (2'' @@ 2''))"

slash_123 [rule_format] :
"makePartial '\\123' = chr(gn_inj(1_3) @@ (2'' @@ 3''))"

slash_124 [rule_format] :
"makePartial '\\124' = chr(gn_inj(1_3) @@ (2'' @@ 4''))"

slash_125 [rule_format] :
"makePartial '\\125' = chr(gn_inj(1_3) @@ (2'' @@ 5''))"

slash_126 [rule_format] :
"makePartial '\\126' = chr(gn_inj(1_3) @@ (2'' @@ 6''))"

slash_127 [rule_format] :
"makePartial '\\127' = chr(gn_inj(1_3) @@ (2'' @@ 7''))"

slash_128 [rule_format] :
"makePartial '\\128' = chr(gn_inj(1_3) @@ (2'' @@ 8''))"

slash_129 [rule_format] :
"makePartial '\\129' = chr(gn_inj(1_3) @@ (2'' @@ 9''))"

slash_130 [rule_format] :
"makePartial '\\130' = chr(gn_inj(1_3) @@ (3'' @@ 0''))"

slash_131 [rule_format] :
"makePartial '\\131' = chr(gn_inj(1_3) @@ (3'' @@ gn_inj(1_3)))"

slash_132 [rule_format] :
"makePartial '\\132' = chr(gn_inj(1_3) @@ (3'' @@ 2''))"

slash_133 [rule_format] :
"makePartial '\\133' = chr(gn_inj(1_3) @@ (3'' @@ 3''))"

slash_134 [rule_format] :
"makePartial '\\134' = chr(gn_inj(1_3) @@ (3'' @@ 4''))"

slash_135 [rule_format] :
"makePartial '\\135' = chr(gn_inj(1_3) @@ (3'' @@ 5''))"

slash_136 [rule_format] :
"makePartial '\\136' = chr(gn_inj(1_3) @@ (3'' @@ 6''))"

slash_137 [rule_format] :
"makePartial '\\137' = chr(gn_inj(1_3) @@ (3'' @@ 7''))"

slash_138 [rule_format] :
"makePartial '\\138' = chr(gn_inj(1_3) @@ (3'' @@ 8''))"

slash_139 [rule_format] :
"makePartial '\\139' = chr(gn_inj(1_3) @@ (3'' @@ 9''))"

slash_140 [rule_format] :
"makePartial '\\140' = chr(gn_inj(1_3) @@ (4'' @@ 0''))"

slash_141 [rule_format] :
"makePartial '\\141' = chr(gn_inj(1_3) @@ (4'' @@ gn_inj(1_3)))"

slash_142 [rule_format] :
"makePartial '\\142' = chr(gn_inj(1_3) @@ (4'' @@ 2''))"

slash_143 [rule_format] :
"makePartial '\\143' = chr(gn_inj(1_3) @@ (4'' @@ 3''))"

slash_144 [rule_format] :
"makePartial '\\144' = chr(gn_inj(1_3) @@ (4'' @@ 4''))"

slash_145 [rule_format] :
"makePartial '\\145' = chr(gn_inj(1_3) @@ (4'' @@ 5''))"

slash_146 [rule_format] :
"makePartial '\\146' = chr(gn_inj(1_3) @@ (4'' @@ 6''))"

slash_147 [rule_format] :
"makePartial '\\147' = chr(gn_inj(1_3) @@ (4'' @@ 7''))"

slash_148 [rule_format] :
"makePartial '\\148' = chr(gn_inj(1_3) @@ (4'' @@ 8''))"

slash_149 [rule_format] :
"makePartial '\\149' = chr(gn_inj(1_3) @@ (4'' @@ 9''))"

slash_150 [rule_format] :
"makePartial '\\150' = chr(gn_inj(1_3) @@ (5'' @@ 0''))"

slash_151 [rule_format] :
"makePartial '\\151' = chr(gn_inj(1_3) @@ (5'' @@ gn_inj(1_3)))"

slash_152 [rule_format] :
"makePartial '\\152' = chr(gn_inj(1_3) @@ (5'' @@ 2''))"

slash_153 [rule_format] :
"makePartial '\\153' = chr(gn_inj(1_3) @@ (5'' @@ 3''))"

slash_154 [rule_format] :
"makePartial '\\154' = chr(gn_inj(1_3) @@ (5'' @@ 4''))"

slash_155 [rule_format] :
"makePartial '\\155' = chr(gn_inj(1_3) @@ (5'' @@ 5''))"

slash_156 [rule_format] :
"makePartial '\\156' = chr(gn_inj(1_3) @@ (5'' @@ 6''))"

slash_157 [rule_format] :
"makePartial '\\157' = chr(gn_inj(1_3) @@ (5'' @@ 7''))"

slash_158 [rule_format] :
"makePartial '\\158' = chr(gn_inj(1_3) @@ (5'' @@ 8''))"

slash_159 [rule_format] :
"makePartial '\\159' = chr(gn_inj(1_3) @@ (5'' @@ 9''))"

slash_160 [rule_format] :
"makePartial '\\160' = chr(gn_inj(1_3) @@ (6'' @@ 0''))"

slash_161 [rule_format] :
"makePartial '\\161' = chr(gn_inj(1_3) @@ (6'' @@ gn_inj(1_3)))"

slash_162 [rule_format] :
"makePartial '\\162' = chr(gn_inj(1_3) @@ (6'' @@ 2''))"

slash_163 [rule_format] :
"makePartial '\\163' = chr(gn_inj(1_3) @@ (6'' @@ 3''))"

slash_164 [rule_format] :
"makePartial '\\164' = chr(gn_inj(1_3) @@ (6'' @@ 4''))"

slash_165 [rule_format] :
"makePartial '\\165' = chr(gn_inj(1_3) @@ (6'' @@ 5''))"

slash_166 [rule_format] :
"makePartial '\\166' = chr(gn_inj(1_3) @@ (6'' @@ 6''))"

slash_167 [rule_format] :
"makePartial '\\167' = chr(gn_inj(1_3) @@ (6'' @@ 7''))"

slash_168 [rule_format] :
"makePartial '\\168' = chr(gn_inj(1_3) @@ (6'' @@ 8''))"

slash_169 [rule_format] :
"makePartial '\\169' = chr(gn_inj(1_3) @@ (6'' @@ 9''))"

slash_170 [rule_format] :
"makePartial '\\170' = chr(gn_inj(1_3) @@ (7'' @@ 0''))"

slash_171 [rule_format] :
"makePartial '\\171' = chr(gn_inj(1_3) @@ (7'' @@ gn_inj(1_3)))"

slash_172 [rule_format] :
"makePartial '\\172' = chr(gn_inj(1_3) @@ (7'' @@ 2''))"

slash_173 [rule_format] :
"makePartial '\\173' = chr(gn_inj(1_3) @@ (7'' @@ 3''))"

slash_174 [rule_format] :
"makePartial '\\174' = chr(gn_inj(1_3) @@ (7'' @@ 4''))"

slash_175 [rule_format] :
"makePartial '\\175' = chr(gn_inj(1_3) @@ (7'' @@ 5''))"

slash_176 [rule_format] :
"makePartial '\\176' = chr(gn_inj(1_3) @@ (7'' @@ 6''))"

slash_177 [rule_format] :
"makePartial '\\177' = chr(gn_inj(1_3) @@ (7'' @@ 7''))"

slash_178 [rule_format] :
"makePartial '\\178' = chr(gn_inj(1_3) @@ (7'' @@ 8''))"

slash_179 [rule_format] :
"makePartial '\\179' = chr(gn_inj(1_3) @@ (7'' @@ 9''))"

slash_180 [rule_format] :
"makePartial '\\180' = chr(gn_inj(1_3) @@ (8'' @@ 0''))"

slash_181 [rule_format] :
"makePartial '\\181' = chr(gn_inj(1_3) @@ (8'' @@ gn_inj(1_3)))"

slash_182 [rule_format] :
"makePartial '\\182' = chr(gn_inj(1_3) @@ (8'' @@ 2''))"

slash_183 [rule_format] :
"makePartial '\\183' = chr(gn_inj(1_3) @@ (8'' @@ 3''))"

slash_184 [rule_format] :
"makePartial '\\184' = chr(gn_inj(1_3) @@ (8'' @@ 4''))"

slash_185 [rule_format] :
"makePartial '\\185' = chr(gn_inj(1_3) @@ (8'' @@ 5''))"

slash_186 [rule_format] :
"makePartial '\\186' = chr(gn_inj(1_3) @@ (8'' @@ 6''))"

slash_187 [rule_format] :
"makePartial '\\187' = chr(gn_inj(1_3) @@ (8'' @@ 7''))"

slash_188 [rule_format] :
"makePartial '\\188' = chr(gn_inj(1_3) @@ (8'' @@ 8''))"

slash_189 [rule_format] :
"makePartial '\\189' = chr(gn_inj(1_3) @@ (8'' @@ 9''))"

slash_190 [rule_format] :
"makePartial '\\190' = chr(gn_inj(1_3) @@ (9'' @@ 0''))"

slash_191 [rule_format] :
"makePartial '\\191' = chr(gn_inj(1_3) @@ (9'' @@ gn_inj(1_3)))"

slash_192 [rule_format] :
"makePartial '\\192' = chr(gn_inj(1_3) @@ (9'' @@ 2''))"

slash_193 [rule_format] :
"makePartial '\\193' = chr(gn_inj(1_3) @@ (9'' @@ 3''))"

slash_194 [rule_format] :
"makePartial '\\194' = chr(gn_inj(1_3) @@ (9'' @@ 4''))"

slash_195 [rule_format] :
"makePartial '\\195' = chr(gn_inj(1_3) @@ (9'' @@ 5''))"

slash_196 [rule_format] :
"makePartial '\\196' = chr(gn_inj(1_3) @@ (9'' @@ 6''))"

slash_197 [rule_format] :
"makePartial '\\197' = chr(gn_inj(1_3) @@ (9'' @@ 7''))"

slash_198 [rule_format] :
"makePartial '\\198' = chr(gn_inj(1_3) @@ (9'' @@ 8''))"

slash_199 [rule_format] :
"makePartial '\\199' = chr(gn_inj(1_3) @@ (9'' @@ 9''))"

slash_200 [rule_format] :
"makePartial '\\200' = chr(2'' @@ (0'' @@ 0''))"

slash_201 [rule_format] :
"makePartial '\\201' = chr(2'' @@ (0'' @@ gn_inj(1_3)))"
...
"makePartial '\\210' = chr(2'' @@ (gn_inj(1_3) @@ 0''))"

slash_211 [rule_format] :
"makePartial '\\211' = chr(2'' @@ (gn_inj(1_3) @@ gn_inj(1_3)))"

slash_212 [rule_format] :
"makePartial '\\212' = chr(2'' @@ (gn_inj(1_3) @@ 2''))"

slash_213 [rule_format] :
"makePartial '\\213' = chr(2'' @@ (gn_inj(1_3) @@ 3''))"

slash_214 [rule_format] :
"makePartial '\\214' = chr(2'' @@ (gn_inj(1_3) @@ 4''))"

slash_215 [rule_format] :
"makePartial '\\215' = chr(2'' @@ (gn_inj(1_3) @@ 5''))"

slash_216 [rule_format] :
"makePartial '\\216' = chr(2'' @@ (gn_inj(1_3) @@ 6''))"

slash_217 [rule_format] :
"makePartial '\\217' = chr(2'' @@ (gn_inj(1_3) @@ 7''))"

slash_218 [rule_format] :
"makePartial '\\218' = chr(2'' @@ (gn_inj(1_3) @@ 8''))"

slash_219 [rule_format] :
"makePartial '\\219' = chr(2'' @@ (gn_inj(1_3) @@ 9''))"

slash_220 [rule_format] :
"makePartial '\\220' = chr(2'' @@ (2'' @@ 0''))"

slash_221 [rule_format] :
"makePartial '\\221' = chr(2'' @@ (2'' @@ gn_inj(1_3)))"
...
"makePartial '\\231' = chr(2'' @@ (3'' @@ gn_inj(1_3)))"
...
"makePartial '\\241' = chr(2'' @@ (4'' @@ gn_inj(1_3)))"
...
"makePartial '\\251' = chr(2'' @@ (5'' @@ gn_inj(1_3)))"
...
"ALL x.
 ALL y.
 ((defOp x & defOp y) &
  gn_inj(ord'(makeTotal x)) <_3 gn_inj(ord'(makeTotal y))) =
 x <_4 y"
...
"ALL x.
 ALL y.
 ((defOp y & defOp x) &
  gn_inj(ord'(makeTotal y)) <=_3 gn_inj(ord'(makeTotal x))) =
 X_maxX4 x y ==' x"
...
"ALL x.
 ...
 ALL y.
 x ==' y -->
 makePartial (X_Cons x xs) ==' makePartial (X_Cons y xs)"
apply(auto)
...
"ALL x.
 ...
 ALL ys.
 xs /= ys -->
 ~ makePartial (X_Cons x ys) ==' makePartial (X_Cons y xs)"
apply(auto)
apply(simp add: ILE02)
apply(case_tac "x ==' y")
apply(auto)
...
theorem StringT3 : "ALL a. ALL b. a /= b --> ~ a ==' b"
...
"ALL x.
 ...
 ALL y.
 x <_4 y -->
 makePartial (X_Cons x xs) <_4 makePartial (X_Cons y xs)"
...
"ALL x.
 ...
 x <_4 y & y <_4 z -->
 ~
 makePartial (X_Cons x (makePartial (X_Cons z (makePartial Nil'))))
 <_4
 makePartial (X_Cons x (makePartial (X_Cons y (makePartial Nil'))))"

...
X_Left :: "'a partial => ('a, 'b) Either partial" ("Left''/'(_')" [3] 999)
X_Right :: "'b partial => ('a, 'b) Either partial" ("Right''/'(_')" [3] 999)
...
"ALL f. ALL g. ALL x. either f g (Left'(x)) = f x"

EitherRightDef [rule_format] :
"ALL f. ALL g. ALL y. either f g (Right'(y)) = g y"

IEE01 [rule_format] :
"ALL x. ALL y. Left'(x) ==' Left'(y) = x ==' y"

IEE02 [rule_format] :
"ALL w. ALL z. Right'(z) ==' Right'(w) = z ==' w"

IEE03 [rule_format] : "ALL x. ALL z. ~ Left'(x) ==' Right'(z)"

IEO01 [rule_format] : "ALL x. ALL z. Left'(x) <' Right'(z)"

IEO02 [rule_format] : "ALL x. ALL y. Left'(x) <' Left'(y) = x <' y"

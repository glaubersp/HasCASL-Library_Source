...
ML "Header.initialize
    [\"ga_selector_pre\", \"ga_injective_suc\", \"ga_disjoint_0_suc\",
     ...
     \"IBO9\", \"IBO10\", \"IBO11\", \"IBO12\", \"ga_generated_Int\",
     ...
     \"IRF01\", \"IRF02\", \"ICE01\", \"ICO04\", \"ICE02\", \"ICO05\",
...
apply(case_tac x)
apply(case_tac y)
apply(simp only: defOp_def)
apply(simp only: makeTotal_def)
apply(case_tac "ord'(snd (a, b))")
oops
...
apply(case_tac "ord'(makeTotal x)")
apply(auto)
apply(simp add: geq_def_Rat)
apply(case_tac "ord'(makeTotal (aa, ba))")
apply(simp add: leq_def_Rat)
apply(case_tac "(aa, ba) <_4 (a, b)")
apply(auto)

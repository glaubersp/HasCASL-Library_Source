...
% Name    : Basic/Numbers_gn_n4_inconsistent
% Author  : hets
% Status  : unknown
% Desc    : 
% Date    : Fri Jun 20 17:09:44 BRT 2008
...
fof(declaration52,axiom,
    int(six_0)).
fof(declaration53,axiom,
    ! [X1] : (nat(X1) => nat(suc(X1)))).
fof(declaration54,axiom,
    ! [X1] : (nat(X1) => pos(suc(X1)))).
fof(declaration55,axiom,
    nat(three)).
fof(declaration56,axiom,
    int(three_0)).
fof(declaration57,axiom,
    nat(two)).
fof(declaration58,axiom,
    int(two_0)).
fof(declaration59,axiom,
    nat(zero)).
fof(declaration60,axiom,
    int(zero_0)).
...
fof(ga_nonEmpty_2,axiom,
    ? [X] : (pos(X) & gn_defined(X))).
fof(ga_notDefBottom_2,axiom,
...
fof(ga_totality_39,axiom,
    ! [X_1, X_2] : ((int(X_1) & int(X_2))
                    => (gn_defined_1(max_2(X_1, X_2))
                        <=> (gn_defined_1(X_1) & gn_defined_1(X_2))))).
fof(ga_totality_40,axiom,
    ! [X_1, X_2] : ((nat(X_1) & nat(X_2))
                    => (gn_defined(max(X_1, X_2))
                        <=> (gn_defined(X_1) & gn_defined(X_2))))).
fof(ga_totality_41,axiom,
    ! [X_1, X_2] : ((int(X_1) & int(X_2))
                    => (gn_defined_1(min_2(X_1, X_2))
                        <=> (gn_defined_1(X_1) & gn_defined_1(X_2))))).
fof(ga_totality_42,axiom,
    ! [X_1, X_2] : ((nat(X_1) & nat(X_2))
                    => (gn_defined(min(X_1, X_2))
                        <=> (gn_defined(X_1) & gn_defined(X_2))))).
fof(ga_totality_43,axiom,
    ! [X_1] : (int(X_1)
               => (gn_defined_1(sign(X_1)) <=> gn_defined_1(X_1)))).
fof(ga_totality_44,axiom,
    ! [X_1] : (nat(X_1)
               => (gn_defined(suc(X_1)) <=> gn_defined(X_1)))).
fof(ga_totality_45,axiom,
    ! [X_1] : (nat(X_1)
               => (gn_defined(suc(X_1)) <=> gn_defined(X_1)))).
...
fof(leq_def_Int,axiom,
    ! [M, N] : ((int(M) & int(N))
                => ((gn_defined_1(M) & gn_defined_1(N))
                    => (p__LtEq___2(M, N)
                        <=> gn_defined(intToNat__(o__Minus___2(N, M))))))).

...
"ALL f. ALL y. maybe y f Nothing = y"

IME01 [rule_format] :
"ALL x. ALL y. Just(x) ==' Just(y) = True' = (x ==' y = True')"

IME03 [rule_format] : "ALL x. Just(x) ==' Nothing = False'"

IMO01 [rule_format] : "ALL x. Nothing <' Just(x) = True'"

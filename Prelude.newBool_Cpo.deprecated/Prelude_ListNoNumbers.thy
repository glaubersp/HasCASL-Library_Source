...
ML "Header.initialize
    [\"Comp1\", \"IdDef\", \"FlipDef\", \"FstDef\", \"SndDef\",
     ...
     \"ScanrProperty\", \"AndLNil\", \"AndLCons\", \"OrLNil\",
     \"OrLCons\", \"AnyDef\", \"AllDef\", \"ConcatDef\",
     \"ConcatMapDef\", \"MaximunNil\", \"MaximumDef\", \"MinimunNil\",
     \"MinimumDef\", \"TakeWhileNil\", \"TakeWhileConsT\",
     \"TakeWhileConsF\", \"DropWhileNil\", \"DropWhileConsT\",
     \"DropWhileConsF\", \"SpanNil\", \"SpanConsT\", \"SpanConsF\",
     \"SpanThm\", \"BreakDef\", \"BreakThm\", \"InsertNil\",
...
"ALL g. ALL q. ALL ys. ys = Nil' --> scanl g q ys = X_Cons q Nil'"
...
Scanl1Nil [rule_format] : "ALL f. scanl1 f Nil' = Nil'"

Scanl1Cons [rule_format] :
"ALL f. ALL x. ALL xs. scanl1 f (X_Cons x xs) = scanl f x xs"

ScanrNil [rule_format] :
"ALL h. ALL z. scanr h z Nil' = X_Cons z Nil'"
...
Scanr1Nil [rule_format] : "ALL f. scanr1 f Nil' = Nil'"

Scanr1ConsNil [rule_format] :
"ALL f. ALL x. scanr1 f (X_Cons x Nil') = X_Cons x Nil'"
...
"ALL g.
 ALL x. ALL ys. last'(scanl g x ys) = makePartial (X_foldl g x ys)"

ScanrProperty [rule_format] :
"ALL h.
 ALL xs. ALL y. head(scanr h y xs) = makePartial (X_foldr h y xs)"

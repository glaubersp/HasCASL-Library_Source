...
"ALL f.
 ...
 ALL y.
 maybe y f
 (restrictOp (makePartial (Just(makeTotal x))) (defOp x)) =
 f x"
...
"ALL x.
 ALL y.
 restrictOp (makePartial (Just(makeTotal x))) (defOp x) =='
 restrictOp (makePartial (Just(makeTotal y))) (defOp y) =
 x ==' y"

theory Prelude_ListNoNumbers_E2
...
apply (auto)
apply(case_tac ys)
apply(simp add: ScanlCons)+
apply(simp add: FoldlCons)
apply(case_tac List)
apply(simp add: FoldlCons)
prefer 3
apply(simp add: ScanlNil)
apply(simp add: makePartial_def)
apply(case_tac "last'(Nil')")
apply(auto)
oops
...
apply(case_tac xs)
apply(auto)
apply(case_tac "scanr h y (X_Cons a List)")
apply(auto)
apply(simp add: makePartial_def)
apply(case_tac List)
apply(simp add: ScanrCons FoldrCons)
apply(auto)
oops
